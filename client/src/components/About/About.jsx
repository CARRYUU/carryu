    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className="text-xl mt-10 px-20 leading-8 tracking-wider text-left break-words">
          ...
          We hope that this project will be in place In the process of learning,
          someone becomes the best helping hand in each position, so the
          platform "covers you" and helps you expand Learn and become a learned
          man. With the development of network technology, people obtain
          information and product investment With the reduction of information,
          access to the Internet has made self-study more and more common. We
          also take this as a starting point and expect It is hoped that this
          project can create an online teaching platform with rich content, so
          that users have an easy opportunity to take courses The good
          environment of the program, instead of spending money and extra effort
          in searching for a professional in the field for courses in different
